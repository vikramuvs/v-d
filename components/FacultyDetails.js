                      ...
                      <table class="min-w-full">
                        ...
                        <tbody>
                          <tr class="border-b bg-white">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                              {data ? data[0]?.duration_of_Designation_1 : null}
                            </td>
                          </tr>
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4  text-sm font-medium text-gray-900">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                              {data ? data[0]?.duration_of_Designation_2 : null}
                            </td>
                          </tr>
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4  text-sm font-medium text-gray-900">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                              {data ? data[0]?.duration_of_Designation_3 : null}
                            </td>
                          </tr>
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4  text-sm font-medium text-gray-900">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                              {data ? data[0]?.duration_of_Designation_4 : null}
                            </td>
                          </tr>
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4  text-sm font-medium text-gray-900">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                              {data ? data[0]?.duration_of_Designation_5 : null}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <>
                      ...
                      <div className="bg-white shadow-lg rounded-md">
                        ...
                        <ul className="list-decimal ml-7">
                          <li className="mb-3">{data ? data[0]?.ha1 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha2 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha3 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha4 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha5 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha6 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha7 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha8 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ha9 : null}</li>
                          <li className="mb-3">
              ...
              {data
                ? data[0]?.do_you_have_research_publications === "Yes" && (
                    <>
                      ...
                      <div className="bg-white shadow-lg rounded-md">
                        <ul className="list-decimal ml-7">
                          <li className="mb-3">{data ? data[0]?.rp1 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp2 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp3 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp4 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp5 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp6 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp7 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp8 : null}</li>
                          <li className="mb-3">{data ? data[0]?.rp9 : null}</li>
                          <li className="mb-3">
              ...
              {data
                ? data[0]
                    ...
                    <>
                      ...
                      <div className="bg-white shadow-lg rounded-md">
                        <ul className="list-decimal ml-7">
                          <li className="mb-3">{data ? data[0]?.wg1 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg2 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg3 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg4 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg5 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg6 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg7 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg8 : null}</li>
                          <li className="mb-3">{data ? data[0]?.wg9 : null}</li>
                          <li className="mb-3">
              ...
              {data
                ? data[0]
                    ...
                    <>
                      ...
                      <div className="bg-white shadow-lg rounded-md">
                        <ul className="list-decimal ml-7">
                          <li className="mb-3">{data ? data[0]?.ps1 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps2 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps3 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps4 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps5 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps6 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps7 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps8 : null}</li>
                          <li className="mb-3">{data ? data[0]?.ps9 : null}</li>
                          <li className="mb-3">
              ...
              {data
                ? data[0]?.do_you_have_books_and_patents === "Yes" && (
                    <>
                      ...
                      <div className="bg-white shadow-lg rounded-md">
                        <ul className="list-decimal ml-7">
                          <li className="mb-3">{data ? data[0]?.bp1 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp2 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp3 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp4 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp5 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp6 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp7 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp8 : null}</li>
                          <li className="mb-3">{data ? data[0]?.bp9 : null}</li>
                          <li className="mb-3">
