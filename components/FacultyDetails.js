  ...
  return data ? (
    <>
      ...
      <div className="grid grid-cols-12 lg:bg-transparent lg:relative font-body">
        ...
        <aside className="col-span-full h-8 border-[1px] place-self-start lg:sticky lg:top-10 border-blue-ramaiah rounded-md  bg-opacity-30 text-blue-ramaiah space-x-3 mx-auto lg:col-start-2 lg:col-end-4 lg:inline-flex lg:flex-col lg:h-auto lg:w-full">
          <div className="lg:w-full lg:flex lg:flex-col text-center">
            <a
              onClick={() => router.back()}
              className="lg:hover:text-white lg:hover:bg-gradient-to-r lg:hover:from-orange-ramaiah lg:to-pink-ramaiah active:bg-opacity-100 bg-opacity-75 lg:p-2 lg:m-2 hover:cursor-pointer"
            >
        ...
        {/* Dept Main Content*/}
        <div className="col-span-full m-2 p-2 lg:col-start-4 lg:col-end-10 h-auto text-black shadow-lg bg-white">
          ...
          <div className="rounded-md mb-6 p-4">
            <div
              ...
              className={
                "flex mb-6 items-start flex-col md:flex-row w-full" /* items-center*/
              }
            >
              <div className="mr-2 flex-grow w-[50%] self-center md:w-[20%]">
                <img
              ...
              <div className="flex-grow md:flex-shrink w-full md:w-[80%] bg-white rounded-md shadow-md p-2">
            ...
            <div className="my-2">
              ...
              {/* <hr className="border-gray-400 text-justify " />{" "} */}
              <div className="flex flex-row flex-wrap justify-evenly bg-white rounded-md shadow-lg p-2 space-x-1 tracking-tighter md:tracking-normal">
                {!(
