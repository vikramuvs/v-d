                                  ...
                                  {!(
                                    ...
                                    <tr class="border-b bg-white">
                                      ...
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                          data[0]
                                            ?.year_of_Completion_of_Degree_1
                                        }
                                      </td>
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                  ...
                                  {!(
                                    ...
                                    <tr class="bg-white border-b">
                                      ...
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                          data[0]
                                            ?.year_of_Completion_of_Degree_2
                                        }
                                      </td>
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                  ...
                                  {!(
                                    ...
                                    <tr class="bg-white border-b">
                                      ...
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                          data[0]
                                            ?.year_of_Completion_of_Degree_3
                                        }
                                      </td>
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                  ...
                                  {!(
                                    ...
                                    <tr class="bg-white border-b">
                                      ...
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                          data[0]
                                            ?.year_of_Completion_of_Degree_4
                                        }
                                      </td>
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                  ...
                                  {!(
                                    ...
                                    <tr class="bg-white border-b">
                                      ...
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
                                          data[0]
                                            ?.year_of_Completion_of_Degree_5
                                        }
                                      </td>
                                      <td class="text-sm text-gray-900 font-light px-6 py-4 ">
                                        {
