      ...
      <div className="grid grid-cols-12 lg:bg-transparent lg:relative font-body">
        ...
        <div className="col-span-full m-2 p-2 lg:col-start-4 lg:col-end-10 h-auto text-blue-ramaiah border-gray-100 border-2 bg-white">
          <div>
            ...
            develop undergraduate courses of best academic standards comparable
            to universities of international repute and be a catalytic agent to
            help students to manifest their latent potential.
            ...
            <p className="text-justify mb-2">
              To Provide the best training through teaching and research to
              enable the students to master the concepts in physics and apply
              successfully to real time problems and to kindle their interest in
            ...
            <br />
            <p className="text-justify mb-2">
              The department of Physics has a team of dynamic and well-qualified
              faculty (all with Ph.D) with a passion for research. It is
              recognized as a Research & Development (R & D) canter by VTU in
              April 2008. Eight research scholars have been awarded Ph.D. from
              the department. At present, one full time and 9 part time research
              scholars have registered for Ph.D. Five external funded research
              projects have been successfully completed and two projects are
              ongoing with external funding of more than Rs. 80 lakhs from BRNS
              and VGST. The Department has very good infrastructure,
              well-equipped spacious laboratories, good computational and
              research facilities. The research lab is equipped with
              Spectrofluorometer, Polarizing Microscope with hot stage, Digital
              microbalance, thin film spin coating unit, Sonicator, muffle
              furnace, vacuum oven and hot air oven. Gaussian 09, Crystal17 and
              other softwares are available in the department for computational
              analysis. At present, active research in the department is in the
              fields of Materials Science, Fluorescence spectroscopy,
              Crystallography, Liquid crystals, Luminescence of Nanomaterials,
              computational studies, Atomic and molecular collisions.
            </p>
            ...
            <ul className="list-disc ml-7">
              ...
              <li>
                The Physics department is one of the oldest departments of the
                M.S. Ramaiah Institute of Technology (MSRIT) established in
                1962. The Physics department has been recognized as VTU research
                centre in April 2008. Engineering Physics emphasizes the basic
                principles underlying most engineering developments, vital to
                engineers of all branches. The department has been working
                towards fulfilling its mission through a synergistic combination
                of teaching and research. The department has been conducting sky
                watch programs, science quiz and guest lectures by eminent
                academicians to kindle the interest of the students.
              </li>{" "}
              {/* <li>
          ...
          >
            The department of Physics is devoted to teach Engineering Physics to
            B.E. first year(All branches) and higher semester (Open elective)
            students. The department has been recognized as research center by
            VTU in 2008. All the faculties are involved in guiding students to
            Ph D. <br />
            <ul className="list-disc ml-7">
              <li>
                Engineering Physics course for B.E. first year (all branches)
                and open elective to higher semester students.
              </li>
              <li>PhD program in Physics under VTU.</li>
            </ul>
            {/* <br />
          ...
          >
            ...
            <ul className="list-disc ml-7">
              <li>
                To familiarize students with the concepts of Elasticity, Theory
                of vibrations and time varying electromagnetic systems and the
                ideas of electromagnetic waves.
              </li>
              <li>
                To expose students to the ideas of wave particle dualism,
                quantum mechanics and basic principles of lasers and optical
                fibres.
              </li>
              <li>
                To impart necessary and practical knowledge of concepts of
                Physics through experiments and develop basic skills and
                confidence in handling instruments.
              </li>
              {/* <li>
            ...
            <ul className="list-disc ml-7">
              ...
              <li>
                Engineering knowledge: The graduates would be able to apply
                knowledge of mathematics, science, and engineering in solving
                Biomedical/Healthcare Problems.
              </li>
              <li>
                Problem analysis: The graduates are expected to possess the
                ability to identify, formulate and solve engineering problem
              </li>
              <li>
                Design/development of solutions: The graduates are expected to
                have the ability to design a system, a component, or a process
                to meet desired needs within realistic constraints such as
                economic, environmental, social, ethical, health and safety,
                manufacturability, and sustainability.
              </li>
              <li>
                Conduct investigations of complex problems: The graduates are
                expected to have the ability to design and conduct experiments,
                as well as to analyze and interpret data.
              </li>
              <li>
                Modern tools usage: The graduates are expected to possess the
                ability to use the techniques, skills, and modern engineering
                tools necessary for engineering practice
              </li>
              <li>
                The engineer and society: The graduates are expected to have
                knowledge of contemporary issues.
              </li>
              <li>
                Environment and sustainability: The graduates are expected to
                have the broad education necessary to understand the impact of
                engineering solutions in a global, economic and societal
                context.
              </li>
              <li>
                Ethics: The graduates are expected to have an understanding of
              ...
              <li>
                Communication: The graduates are expected to communicate
                effectively.
              </li>
              <li>
                Project management and finance: Implement the concepts of
                project and financial Management to satisfy customer
                expectations.
              </li>
              <li>
                Life-long learning: The graduates are expected to engage
                themselves in life-long learning.
              </li>
            </ul>{" "}
            <br />
            ...
            {/* The Programme outcomes are defined by National Board of
              ...
              <li>
                PSO1: Acquire and comprehend the basic skill sets required for
                Medical Electronics Engineering.
              </li>
              <li>
                PSO2: Implement the techniques and tools of Medical Electronics
                Engineering to address the needs of technology in healthcare
                domain.
              </li>
              <li>
                PSO3: Exhibit the professional communication and team building
                skills imbibing the socio-ethical values.
              </li>
            </ul>*/}
          </div>
          ...
          >
            <strong>Dr. A. Jagannatha Reddy</strong> <br />
            <img
              src="https://msrit-bucket.s3-us-west-2.amazonaws.com/Gallery/hod/physics.jpg"
              className="mx-auto text-center w-[200px] h-[200px]"
            />
            <p className="text-justify mb-2">
              Dr. A. Jagannatha Reddy obtained his Bachelors degree in Science &
              Masters degree in Physics from Bangalore University with
              distinction. He received PhD in Physics from Bangalore University
              for the doctoral work on “Structural and luminescence studies of
              transition metal and rare earth ion doped zinc oxide nano
              materials”. He joined the department of Physics of MSRIT as a
              lecturer in the year 1990. He has about 29 years of teaching and
              14 years of research experience. He has published 14 research
              papers in peer reviewed International Journals and
              presented/published 20 research articles in International and
              National conferences. He is a recognized guide in VTU and is
              currently guiding 3 Ph.D. students.
            </p>{" "}
          </div>
        </div>
        {/* Dept Right Sidebar */}
