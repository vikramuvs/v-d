      ...
      <div className="grid grid-cols-12 lg:bg-transparent lg:relative font-body">
        ...
        <div className="col-span-full m-2 p-2 lg:col-start-4 lg:col-end-10 h-auto text-blue-ramaiah border-gray-100 border-2 bg-white">
          <div>
            ...
            <div className="font-heading text-lg"> VISION</div> <br /> Provide
            quality education and a motivational academic environment and foster
            strong Institute-industrial ties to empower the students to face the
            ...
            <p className="text-justify mb-2">
              The department shall transform the entrant of the program into
              professionally competent engineers through innovative curricula,
              research, practical training and effective collaboration with
              industry, hospital, and academia.
            </p>
            {/* <div className="font-heading pt-2 text-lg">MISSION</div> <br />{" "}
            {mission} */}
            ...
            <p className="text-justify mb-2">
              ...
              Institute of Technology (MSRIT), Bangalore was established in the
              year 1996 under Bangalore University (BU) till 2002 with an intake
              of 30 and then under Visvesvaraya Technological University
              (VTU).Now under the institute autonomous status the department is
              affiliated to VTU with an intake of 60 currently. The department
              offers 4-year fulltime undergraduate degree in Bachelor of
              Engineering in Medical Electronics Engineering, affiliated to VTU,
              Belgaum, recognized by Government of Karnataka, approved by AICTE,
              New Delhi .The department is also accredited by National Board of
              Accreditation and is IQAC certified. The department boasts of an
              amalgamation of both experienced and young faculties who have
              excellence in diverse fields including Biomedical instrumentation
              , Electronics & Communication ,Control Systems , Signal/Image
              Processing , BioMEMS , Nanoscience & Technology The department
              consists of a highly motivated & well qualified faculty and
              dedicated supporting staff headed by Dr. N. Sriraam, with a wide
              experience in industry and academics with specialization in
            ...
            <ul className="list-disc ml-7">
              ...
              <li>
                The department offers 4-year fulltime undergraduate degree in
                Bachelor of Engineering in Medical Electronics Engineering,
                affiliated to VTU, Belgaum, recognized by Government of
          ...
          >
            Department of Medical Electronics Engineering offers two programs
            that are affiliated to VTU – Belgaum and recognized by AICTE: <br />
            <ul className="list-disc ml-7">
              <li>
                Bachelor of Engineering Degree in Medical Electronics
                Engineering.
              </li>
          ...
          >
            ...
            <ul className="list-disc ml-7">
              <li>
                PEO1: Solve the real-life engineering problems by employing the
                knowledge and skills of Medical Electronics.
              </li>
              <li>
                PEO 2: Provide a multi-disciplinary environment to link
                engineering and medical domains.
              </li>
              <li>
                PEO 3: Inculcate professional and ethical values in lifelong
                learning process.
              </li>
              {/* <li>
          ...
          >
            <strong>Dr. C K Narayanappa</strong> <br />
            <img
              src="https://msrit-bucket.s3-us-west-2.amazonaws.com/Gallery/hod/ckn_hod.png"
              className="mx-auto text-center w-[200px] h-[200px]"
            />
            <p className="text-justify mb-2">
              C K Narayanappareceived the B.E degree in Electronics Engineering
              in 1993 from BMSCE, Bangalore and the M. Tech degree in Biomedical
              Instrumentation in 1996 from SJCE, Mysore. He received the Ph.D.
              degree in Electrical Engineering Sciences from VTU in 2014 in the
              area of Control Systems. He is currently working as Associate
              Professor and Head,Department of Medical Electronics Engineering,
              Ramaiah Institute of Technology,Bengaluru, Karnataka,India. His
              research interest is mainly focused on Control systems, Biomedical
              Instrumentation and Image processing. Professional Memberships
              includesFIE,ISTE, IETE and BMESI. He is the co-author of
              Engineering Electromagnetics, Cengage Publications. He is the
              author or co-author of articles published in Scopus indexed
              journals and guiding research scholars Under VTU, Belagavi.
            </p>{" "}
          </div>
        </div>
        {/* Dept Right Sidebar */}
