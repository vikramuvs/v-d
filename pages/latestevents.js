...
import NewsEventsBanner from "../components/NewsEventsBanner";
...
export async function getStaticProps() {
  ...
  //     "http://ec2-54-214-223-171.us-west-2.compute.amazonaws.com:8080/api/v1/research/"
  //   );
  ...
  const l_e = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/latest_events/all"
  );
