    ...
    <>
      ...
      <div className="font-body">
        ...
        <DeptBanner
          ...
          deptName="DEPARTMENT OF HUMANITITES"
...
export async function getStaticProps() {
  const res = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/bos/17"
  );
  const json = await res.json();

  const resboe = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/boe/17"
  );
