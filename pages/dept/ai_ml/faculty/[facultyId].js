...
export async function getStaticPaths() {
  ...
  const res = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/fd_responses/dept/36"
  );
...
export async function getStaticProps({ params }) {
  ...
  const dep_stat = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/dept_stats/36"
  );
