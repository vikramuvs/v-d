    ...
    <>
      ...
      <div className="font-body">
        ...
        <DeptBanner
          ...
          deptName="DEPARTMENT OF COMPUTER SCIENCE & ENGG (CYBER SECURITY)"
        />
...
export async function getStaticProps() {
  const res = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/achievements/38"
  );
  const json = await res.json();

  const fa = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/faculty_achievements/38"
  );
  const fa_json = await fa.json();

  const patent = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/patents/38"
  );
  ...
  const l_e = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/latest_events/38"
  );
  const l_eJson = await l_e.json();

  const l_n = await fetch(
    "http://ec2-52-39-2-31.us-west-2.compute.amazonaws.com:8080/api/v1/latest_news/38"
  );
