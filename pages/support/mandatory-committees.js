...
import MadatoryCommittee from "../../components/SupportingSections/MadatoryCommittee";

function mandatory_committees({ latestNews, latestEvents, deptStats }) {
  return (
    <>
      <Head>
...
export default mandatory_committees;
