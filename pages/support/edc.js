...
import CompEdc from "../../components/SupportingSections/edc";

function edc({ latestNews, latestEvents, deptStats }) {
  return (
    <>
      <Head>
      ...
      <div className="font-body">
        ...
        <DeptBanner
          ...
          deptName={"EDC"}
          bkg="bg-edc bg-gray-deptHeader bg-blend-overlay bg-cover"
        />
