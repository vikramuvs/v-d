...
import ProctorialSystem from "../../components/SupportingSections/ProctorialSystem";

function proctorial_system({ latestNews, latestEvents, deptStats }) {
  return (
    <>
      <Head>
...
export default proctorial_system;
