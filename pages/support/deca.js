...
import Deca from "../../components/SupportingSections/Deca";

function deca({ latestNews, latestEvents, deptStats }) {
  return (
    <>
      <Head>
      ...
      <div className="font-body">
        ...
        <DeptBanner
          ...
          deptName={"DECA"}
          bkg="bg-deca bg-gray-deptHeader bg-blend-overlay bg-left"
        />
